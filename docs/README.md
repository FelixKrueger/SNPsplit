...
SNPsplit offers a separate [genome preparation](./genome_prep/genome_preparation.md) step that allows you to generate N-masked (or fully incorporated) SNP genomes for single or dual hybrid strains for all strains of the Mouse Genomes Project. Please see below for further details.
